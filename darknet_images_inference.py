# -*- coding: utf-8 -*-
"""
Created on Thu Apr 29 12:12:06 2021
...
def parser():
    ...
    input_images = './test_folder/'
    batch_size = 1
    weights = './yolo-obj_7000.weights'
    ext_output = True
    save_labels = True
    ...
    parser.add_argument("--ext_output", action='store_true', default=ext_output,
                        help="display bbox coordinates of detected objects")
    parser.add_argument("--save_labels", action='store_true',default=save_labels,
